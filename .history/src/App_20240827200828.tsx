  ...
  return (    
    <SoundProvider>
      <pageContext.Provider value={{
        ...
        currScore,
        bestScore,
        selectedLevel: selectLevelActive,
        winActive,
        loseActive,
        setCharList,
        setWinActive,
        ...
        setCurrScore,
        setBestScore,
        setSelectedLevel: setSelectLevelActive
      }}>
        {loadingPageActive? <LoadingPage /> : difficultyActive? <DifficultyPage /> : winActive? <WinPage /> : loseActive? <LosePage /> : <GamePage />}
      </pageContext.Provider>
      <SoundBtn />  {/* Sound button */}    
      <div className="app-footer">
        <p>Developed by <a href="https://github.com/victorhugolimas" target="_blank">Victor Hugolimas</a></p>
      </div>  {/* Footer */}
    </SoundProvider>
